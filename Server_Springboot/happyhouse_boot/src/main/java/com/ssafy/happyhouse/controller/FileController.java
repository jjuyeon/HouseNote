...
//		FileDTO dto = session.selectOne("ssafy.files.fileone", fid);
...
//		List<FileDTO> filelist = session.selectList("ssafy.files.filelist");
...
//				
//				session.insert("ssafy.files.fileinsert",
//						new FileDTO(originalFileName, folder.toString()+ File.separator + originalFileName));
...
//				String oriName = null;
//				//
//				// oriName = new String(mfile.getOriginalFilename().getBytes("8859_1"),
//				// "UTF-8");
//				oriName = mfile.getOriginalFilename();
//				if ("".equals(oriName)) {
//					continue;
//				}
//
...
//				"oriFileName:" + resultList.get(0).get("oriName") + ", saveFileName:" + resultList.get(0).get("sfile"));
//		return "index";
//	}
//
//	
